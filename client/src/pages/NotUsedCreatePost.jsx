          ...
          <div className=" mt-[7rem]">
            <Xanimation>
              <h2 className=" text-2xl font-bold text-color-dark mb-5 ">
                {!isEditing ? 'Publicar anuncio' : 'Editar anuncio'}
              </h2>
            </Xanimation>
            {/* {error && (
            ...
            <Yanimation>
              <form action="" onSubmit={!isEditing ? create : edit}>
                <Stack spacing={4}>
                  <InputGroup size="sm">
                    <InputLeftAddon
                      pointerEvents="none"
                  ...
                  <InputGroup size="sm">
                    ...
                    <Select
                      size="sm"
                      name="province"
                      value={isEditing ? selectedProvince : ''}
                      onChange={(e) => {
                  ...
                  <FormControl id="fileUpload">
                    <Dragger {...props} customRequest={handleCustomRequest}>
                      ...
                      <p className="ant-upload-hint">
                        Solo soporta archivos únicos. No se permiten archivos de
                        más de 2MB.
                      </p>
                    </Dragger>
                  </FormControl>
                  ...
                  <Button
                    ...
                    size="sm"
                  >
                    {!isEditing ? 'Crear anuncio' : 'Actualizar anuncio'}
                  </Button>
                </Stack>
              </form>
            </Yanimation>
